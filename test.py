...
parser.add_argument('--config', default='config.yaml', type=str, help="net configuration")
parser.add_argument('--input', type=str, default='./afhq/test/a/cat/pixabay_cat_000615.jpg', help="input image path")
parser.add_argument('--output_folder', type=str, default='./result', help="output image path")
parser.add_argument('--checkpoint', type=str, default='./outputs/config/checkpoints/gen_00200000.pt', help="checkpoint of autoencoders")
parser.add_argument('--style', type=str, default='./afhq/test/b/dog/flickr_dog_000157.jpg', help="style image path")
